...
export function PlansPage() {
  ...
  const [form, setForm] = useState({ code: '', name: '', description: '', amount: '', cycle: 'monthly', grace_days: '5', trial_days: '0', solution_ids: [] as string[] });
