          ...
          <div className="bg-white p-6 rounded-2xl border border-[#DDD8CF]/40 shadow-sm">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <div className={`text-sm font-medium ${health.database === 'connected' ? 'text-green-600' : 'text-red-600'}`}>
                  {health.database === 'connected' ? 'Conectado (Supabase)' : 'Desconectado'}
                </div>
              </div>
            </div>
            <div className="text-sm text-gray-500 space-y-2 mt-4 pt-4 border-t border-gray-100">
          ...
          <div className="bg-white p-6 rounded-2xl border border-[#DDD8CF]/40 shadow-sm">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <div className={`text-sm font-medium ${health.auth === 'connected' ? 'text-green-600' : 'text-red-600'}`}>
                  {health.auth === 'connected' ? 'Serviço Ativo' : 'Fora do ar'}
                </div>
              </div>
            </div>
            <div className="text-sm text-gray-500 space-y-2 mt-4 pt-4 border-t border-gray-100">
