...
const company = "Grupo Horizonte";
const teamName = "Equipe Comercial — Piloto";
const planName = "Ordum Integridade — Piloto";
...
try {
  ...
  await page.getByRole("heading", { name: "Comercial", exact: true }).waitFor({ timeout: 20000 });
