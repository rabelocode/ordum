...
export function AdminDashboard() {
  const { platformRole, platformMember, memberTeams, managedTeams } = usePlatform();
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-[#DDD8CF]/40 shadow-sm">
          ...
          <div className="text-3xl font-black text-[#202322]">-</div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-[#DDD8CF]/40 shadow-sm">
          ...
          <div className="text-3xl font-black text-[#202322]">
            {platformRole?.key === 'admin' ? '-' : managedTeams.length + memberTeams.length}
          </div>
        </div>
      </div>
